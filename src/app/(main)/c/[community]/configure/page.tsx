...
import { Checkbox, Divider, Input, Radio, RadioGroup, Spinner, Textarea } from '@nextui-org/react'
...
const ConfigureCommunity = ({ params }: { params: Params }) => {
  ...
  return (
    <div className="col-span-9 space-y-6 rounded-xl bg-dark-2 px-8 py-7">
      <title>Configure {data.name} community</title>
      ...
      <div>
        ...
        <Checkbox
          ...
          onChange={(e) => setCommunityData((prev) => ({ ...prev, scrutinizeToPost: e.target.checked }) as Community)}
        >
