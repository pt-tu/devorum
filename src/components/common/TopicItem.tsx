    ...
    >
      ...
      <div className="flex flex-row max-h-min">
        ...
        <div className="ml-4 flex-1 h-full">
          <p className="text-gray-bg font-normal text-sm">Thanh Tú</p>
          <p className="text-gray-400 font-light text-[10px]">5 min ago</p>
        </div>
      ...
      <div>
        ...
        <p className="text-gray-3 font-light text-sm overflow-hidden whitespace-nowrap w-full overflow-ellipsis">
